...
- Rebase executado em 2026-09-04 para `upstream/dev @ c302ae6f35b4f6c11365f4a8705e894d721706e0`
  (42 commits desde `04e4fd6b`), sem conflitos nos 13 commits da pilha.
  `upstream/main` em `c13990a398909c0ec80973f9b9cbebaa8aa40000`.
  Motivo do peso do client-jest documentado em `docs/brand/patches/brand-04-theme.md`:
  check leve `node scripts/brand/check-theme.mjs` substitui `jest arvorepress`.
